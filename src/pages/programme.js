    ...
    <ContentPage pageTitle="PhD Programme" headerClass={ProgrammesStyle.header}>
      <div class="columns">
        <div class="column">
          ...
          <br />
          <a
            href="https://mysis.qmul.ac.uk/urd/sits.urd/run/siw_ipp_lgn.login?process=siw_ipp_app&amp;code1=RFQM-G4ZX-09&amp;code2=0011 "
            target="_blank"
          >
            <button>Apply Now to start in September 2021</button>
          </a>
          <h1>PHD PROGRAMME STRUCTURE</h1>
          <p>
          ...
          <ol>
            <li>
              Six&nbsp;advanced taught modules ranging from advanced technical
              skills to interaction design;
            </li>
            <li>An advanced research project;</li>
            <li>PhD research examined by thesis and viva.</li>
          </ol>
          <p>The programme is structured as follows:</p>
          <ul>
            <li>
              Year 1: 90 credits of taught modules, and 90 credits of research
              project
            </li>
            <li>
              Years 2, 3, 4, 5: PhD research programme following the progression
              points of EECS PhD policies and procedures
            </li>
          </ul>
          <p>The main research groups contributing to the programme are:</p>
          <ul>
            <li>
              <a title='\"Antennas' href="http://antennas.eecs.qmul.ac.uk/">
                Antennas
              </a>
              ;
            </li>
            <li>
              <a title='\"c4dm' href="http://c4dm.eecs.qmul.ac.uk/">
                Centre for Digital Music
              </a>
              ;
            </li>
            <li>
              <a title='\"CIS' href="http://cis.eecs.qmul.ac.uk/">
                Centre for Intelligent Sensing
              </a>
              ;
            </li>
            <li>
              <a title='\"CogSCI' href="http://cogsci.eecs.qmul.ac.uk/">
                Cognitive Science
              </a>
              ;
            </li>
            <li>
              <a
                title='\"MMV'
                href="http://www.eecs.qmul.ac.uk/research/view/multimedia-and-vision-mmv"
              >
            ...
            <li>
              <a title='\"MMV' href="http://www.qmul.ac.uk/robotics/">
                Advanced Robotics
              </a>
            </li>
          </ul>
          ...
          <h4>Core modules are usually:</h4>
          <ul>
            <li>
          ...
          <h4>Suggested elective modules to choose from are:</h4>
          <p>Semester 1 (one elective):</p>
          <ul>
            <li>
          ...
          <p>
            <strong>Please note</strong>: The MAT PhD Programme is a four year
          ...
          <ul>
            <li>
              <a href="https://www.chinesescholarshipcouncil.com">
            ...
            <li>
              <a href="https://www.conicyt.cl">https://www.conicyt.cl</a>
            </li>
            <li>
              <a href="https://study-uk.britishcouncil.org/scholarships/commonwealth-scholarship">
                https://study-uk.britishcouncil.org/scholarships/commonwealth-scholarship
              </a>
            </li>
            <li>
              <a href="https://www.lahp.ac.uk/apply-for-a-studentship/">
                https://www.lahp.ac.uk/apply-for-a-studentship/
              </a>
            </li>
          </ul>
          <p>
            (The Media and Art Technology PhD Programme does not provide
            scholarships).
          </p>
          <h1>HOW TO APPLY</h1>
          <p>
          ...
          <p>
            To apply for the MAT PhD&nbsp;Programme, complete the{" "}
            <a href="https://mysis.qmul.ac.uk/urd/sits.urd/run/siw_ipp_lgn.login?process=siw_ipp_app&amp;code1=RFQM-G4ZX-09&amp;code2=0011">
          ...
          <ol>
            <li>
              The online application link above will take you directly to the
            ...
            <li>
              Fully complete the application form, upload transcripts of your
            ...
            <li>
              Provide a one&nbsp;page&nbsp;A4 “Statement of Purpose” – a pdf
            ...
            <li>
              Two references are required – either two academic, or one academic
              ...
              including the application number in the subject:{" "}
              <a href="mailto:admissions@qmul.ac.uk">admissions@qmul.ac.uk</a>
              ).
            </li>
            <li>
              Select a supervisor – have a look at&nbsp;the research groups at
              the following&nbsp;link for ideas and then click into the group
              and the research staff to find possible supervisors:{" "}
              <a href="http://www.eecs.qmul.ac.uk/research">
            ...
            <li>
              Provide a two page A4 “Research Proposal” – a pdf document in
              which you provide an outline of the research topic agreed with
              your selected supervisor.
            </li>
            <li>
              In the box “How do you intend to finance your studies at Queen
            ...
            <li>
              If you have a&nbsp;serious problem with the online application
              form&nbsp;please&nbsp;email{" "}
              <a href="mailto:admissions@qmul.ac.uk">admissions@qmul.ac.uk</a>.
            </li>
          </ol>
          <p>
            If you are an overseas student there is helpful advice on our&nbsp;
            <a href="http://www.qmul.ac.uk/international/international-students/">
              International pages
            </a>
            &nbsp;and on the&nbsp;
            <a href="http://www.ukcosa.org.uk/">
              UK Council for International Student Affairs
            </a>
            &nbsp;website. The College’s standard requirement for English is
            IELTS 6.5 or equivalent. More details about language requirements
            can be found in the&nbsp;
            <a href="http://www.qmul.ac.uk/international/international-students/englishlanguagerequirements/index.html">
              international students
            </a>
            &nbsp;section.
          </p>
          <h1>FURTHER ADVICE</h1>
          <p>
            Email j.winfield”at”qmul.ac.uk for informal enquiries on the program
            and the application process if you cannot find the answers above.
          </p>
        </div>
